...
class _SwapScreenState extends State<SwapScreen> {
  ...
  AppBar appbar() {
    return AppBar(
      ...
      centerTitle: true,
      title: Text('swap'.translate.toUpperCase(), style: context.headline6),
      actions: [
        Padding(
  ...
  Widget body() {
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            customText('ACRO', context.headline6),
            swapLine(0),
            divider(),
            customText('TL', context.headline6),
            swapLine(1),
            sized(),
            swapButton(),
            Spacer(),
            Row(
              ...
              children: [
                customText(
                  'Max price slippage: 1%',
                  context.headline6
                      .copyWith(fontSize: 10, color: context.highlightColor),
                ),
                customText(
                  'Gas price: 164 GWEI',
                  context.headline6
  ...
  RoundedButton swapButton() {
    return RoundedButton(
      buttonTextKey: 'swap_now',
      textStyle: context.headline6.copyWith(color: context.accentColor),
      borderRadius: context.mediumCircular,
      action: () {},
  ...
  Row swapLine(int selectedItem) {
    return Row(
      children: [
        tokenDrowdown(selectedItem),
        priceTextFormField(),
        equalsText()
      ],
    );
  ...
  AutoSizeText equalsText() {
    return AutoSizeText('= 0,32',
        style: context.headline6
            .copyWith(color: context.highlightColor, fontSize: 12));
  }

  Expanded priceTextFormField() {
    return Expanded(
        child: Padding(
      padding: context.horizontalLowMed,
      child: TextFormField(
        style: context.headline6.copyWith(fontSize: 25),
  ...
  Row tokenDrowdown(int selectedItem) {
    return Row(
      children: [
        DropdownButton<Widget>(
          underline: SizedBox(),
          itemHeight: 80,
          items: tokenImageList.map((Widget value) {
            return DropdownMenuItem<Widget>(
              value: value,
              child: value,
            );
          }).toList(),
          value: tokenImageList[selectedItem],
          onChanged: (_) {},
        ),
      ],
    );
