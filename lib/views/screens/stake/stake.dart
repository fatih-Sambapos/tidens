...
class _StakeScreenState extends State<StakeScreen> {
  ...
  Widget body() {
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            subHeader('available_balance'.translate),
            stakeTextFormField(
              Column(
            ...
            subHeader('current_staking_amount'.translate),
            stakeTextFormField(
                Icon(Icons.lock, color: context.highlightColor), false),
            divider(),
            subHeader('amount_you_want_to_deposit'.translate),
            stakeTextFormField(
                Icon(Icons.lock, color: context.highlightColor), true),
            sized(),
            stakeButton(),
          ],
        ),
  ...
  Padding subHeader(String text) {
    return Padding(
      ...
      child: Row(
        children: [
          customText(text, context.headline6.copyWith(fontSize: 18)),
        ],
      ),
    );
  }

  RoundedTextButton stakeTextFormField(Widget prefixIcon, bool enabled) {
  ...
  RoundedButton stakeButton() {
    return RoundedButton(
      buttonTextKey: 'stake_now',
